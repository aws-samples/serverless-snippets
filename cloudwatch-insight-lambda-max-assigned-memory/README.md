...
Returns the number of Lambda invocations that used 100% of assigned memory.

Learn more about this snippet at Serverless Land Snippets: https://serverlerssland.com/snippets/cloudwatch-insight-lambda-max-assigned-memory
...
[Follow the instructions on the snippet page](https://serverlerssland.com/snippets/cloudwatch-insight-lambda-max-assigned-memory) to run in your AWS account.
