...
Returns the number of invocations where Lambda timed out

Learn more about this snippet at Serverless Land Snippets: https://serverlerssland.com/snippets/cloudwatch-insight-lambda-invocations-timed-out
...
[Follow the instructions on the snippet page](https://serverlerssland.com/snippets/cloudwatch-insight-lambda-invocations-timed-out) to run in your AWS account.
