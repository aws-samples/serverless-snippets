...
Returns the number of invocations where Lambda exited

Learn more about this snippet at Serverless Land Snippets: https://serverlerssland.com/snippets/cloudwatch-insight-lambda-invocation-where-lambda-exited
...
[Follow the instructions on the snippet page](https://serverlerssland.com/snippets/cloudwatch-insight-lambda-invocation-where-lambda-exited) to run in your AWS account.
